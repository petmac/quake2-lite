...
void CL_ParseMuzzleFlash (void)
{
	...
	case MZ_RAILGUN:
		...
		break;
	case MZ_ROCKET:
		dl->color[0] = 1;dl->color[1] = 0.5;dl->color[2] = 0.2f;
...
void CL_ItemRespawnParticles (vec3_t org)
{
	...
	for (i=0 ; i<64 ; i++)
	{
		...
		p->color = (float)(0xd4 + (rand()&3));	// green
